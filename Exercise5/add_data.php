...
if(isset($_POST['btn-save']))
{
 ...
 // sql query for inserting data into database
        ...
        $sql_query = "INSERT INTO dbtuts(name,nickname,email,phone,homead,comment,gender) VALUES('$name','$nickname','$email','$phone','$homead','$comment','$gender')";
...
<div id="body">
 <div id="content">
    ...
    <table align="center">
    <tr>
    <td align="center"><a href="homepage.php">back to main page</a></td>
    </tr>
    <tr>
